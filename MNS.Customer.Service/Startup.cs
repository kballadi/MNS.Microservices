...
using MNS.Services.Customer.Middlewares;
...
namespace MNS.Customer.Service
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "MNS.Customer.Service",
                    Version = "v1",
                    Description = "A Mobile Network Service Management API for the customer to register and buy the plans respectively.",
            ...
            services.AddHttpClient<IMobilePlanService, MobilePlanService>(c => c.BaseAddress = new Uri(Configuration["ApiConfigs:Mobile:Uri"]))
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MNS.Customer.Service v1"));
            }
